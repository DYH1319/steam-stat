...
namespace ElectronNet.Migrations
{
    ...
    [Migration("20260418090053_AddFriendStatusRecord")]
    partial class AddFriendStatusRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElectronNet.Models.GlobalStatus", b =>
                {
                    ...
                    b.Property<string>("ActiveUserSteamId")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT")
                    ...
                    b.Property<int?>("SteamAppRefreshTime")
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("ElectronNet.Models.SteamLoginToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.ToTable("steam_login_token", null, t =>
                        {
                            t.HasComment("Steam 登录 Token 表");
                        });
                });
