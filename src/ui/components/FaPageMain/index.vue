...
<template>
  ...
  >
    ...
    <div
      :class="cn('group/pagemain relative h-[calc-size(auto,size)] p-5 transition-height after:(pointer-events-none absolute bottom-0 left-0 z-1 h-12 max-h-full w-full from-transparent to-[var(--card)] bg-gradient-to-b opacity-0 transition-opacity content-empty)', {
        'overflow-hidden': collaspe,
