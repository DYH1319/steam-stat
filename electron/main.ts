...
import { app, BrowserWindow, globalShortcut, ipcMain, Menu, net, protocol, screen, shell, Tray } from 'electron'
...
app.whenReady().then(async () => {
  ...
  // 使用 protocol.handle() 替代已弃用的 protocol.registerFileProtocol()
  protocol.handle('steam-avatar', (request) => {
    ...
    try {
      ...
      console.error('[Protocol] 处理 steam-avatar 协议失败:', error)
